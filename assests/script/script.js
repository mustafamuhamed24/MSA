...
// Create-Function ----------------------------------------
let AddBtn = () => {
    if (Sector.value != '' && PermitStartDate.value != '' && ExpiredDate.value != '' && PermitDescrpition.value != '' && CM_Employeee.value != '' && fileInput.value != '' && Unit_Number_Input.value != '' && Passenger.value != '') {
