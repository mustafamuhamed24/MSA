...
let UnitType = document.getElementById("Unit_type");
...
let Security_Notes = document.getElementById('Security_Notes');
let Login_Time = document.getElementById('Login_Time');
let Site_Name = document.getElementById('Site_Name');
let Login_Type = document.getElementById('Login_Type');
let Login_Date = document.getElementById('Login_Date');
...
// Create-Function ----------------------------------------
let AddBtn = () => {
    if (Sector.value != '' && Login_Date.value != '' && UnitType.value != '' && Login_Time.value != '' && Login_Type.value != '' && Security_Notes.value != '' && Site_Name.value != '' && PermitStartDate.value != '' && ExpiredDate.value != '' && PermitDescrpition.value != '' && CM_Employeee.value != '' && fileInput.value != '' && Unit_Number_Input.value != '' && Passenger.value != '') {
        ...
        fileToBase64(File, function (base64String) {
            let ClientInfo = {
                ...
                Login_Date: Login_Date.value,
                Login_Time: Login_Time.value,
                Login_Type: Login_Type.value,
                Security_Notes: Security_Notes.value,
...
let showData = () => {
    ...
    for (let i = 0; i < ClientData.length; i++) {
        ...
        <td>${ClientData[i].Security_Notes}</td>
        <td>${ClientData[i].Login_Time}</td>
        <td>${ClientData[i].Login_Type}</td>
        <td>${ClientData[i].Site_Name}</td>
