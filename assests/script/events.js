...
// Create-Function ----------------------------------------
let AddBtn = () => {
    if (ClientName.value != '' && UnitNumber.value != '' && PermitStartDate.value != '' && ExpiredDate.value != '') {
        let ClientInfo = {
        ...
        alert('Please Complete your Event Info')
    }
}
...
let GetSearchMood = (value) => {
    ...
    if (value == 'search by content') {
        SearchMood = 'Content';
        search.value = '';
        search.placeholder = 'Search By Content '
    }
    if (value == 'search by permit start date') {
        SearchMood = 'StartDate';
        search.value = '';
        search.placeholder = 'Search By Start Date '
    }
    if (value == 'search by expired date') {
